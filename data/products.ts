...
const productNames: Record<string, string> = {
  ...
  "arreglo-30": "Esfera de Girasoles y Gerberas",
  "arreglo-31": "Fuego de Sol",
  "arreglo-32": "Hechizo de Amor",
  "arreglo-33": "Cofre de Ternura",
  "arreglo-34": "Maceta Encanto Pastel",
  "arreglo-35": "Esfera Majestuosa",
  "arreglo-36": "Jardín Secreto",
  "arreglo-37": "Elegancia Carmesí",
  "arreglo-38": "Jarra Dulce Armonía",
  "arreglo-39": "Ramillete Encanto Pastel",
  "arreglo-40": "Ramillete Aristócrata",
  "arreglo-41": "Elegancia en Blanco",
  "arreglo-42": "",
  "arreglo-43": "",
  "arreglo-44": "",
  "arreglo-45": "",
...
const productDescriptions: Record<string, string> = {
  ...
  "arreglo-30": "Un diseño compacto y sumamente alegre que desborda vitalidad a través de una combinación cítrica de colores. Este arreglo destaca por la armoniosa presencia de gerberas en tonos amarillo brillante y naranja encendido, acompañadas por la suavidad de claveles o crisantemos en matices coral y pequeños brotes amarillos que añaden textura y dinamismo visual. El conjunto descansa de manera impecable sobre una densa base esférica de follaje verde brillante, salpicada con delicados toques de gipsofila (nube blanca) que aportan frescura y contraste. Presentado en una original maceta redondeada de tono lila pastel, es el detalle perfecto para desear un feliz cumpleaños, enviar ánimos de pronta recuperación o simplemente iluminar el día de alguien con una vibrante inyección de energía natural.",
  "arreglo-31": "Una propuesta compacta y llena de magnetismo visual que irradia calidez y vitalidad. Este vibrante diseño destaca por un imponente girasol central plenamente abierto, rodeado por una corona de hermosas rosas premium en un intenso tono rosa rojizo o fucsia que genera un contraste espectacular y moderno. El arreglo se enriquece con la alegre textura de crisantemos bicolores en tonos magenta y amarillo, distribuidos armoniosamente sobre una densa y fresca base de follaje verde brillante. Presentado de forma impecable en un jarrón estilizado de tono oscuro que resalta la viveza de sus colores, es el detalle ideal para celebrar un cumpleaños con optimismo, desear éxito en un nuevo proyecto o sorprender a alguien especial con un estallido de energía y buen gusto.",
  "arreglo-32": "Un diseño clásico, tierno y profundamente romántico que cautiva por su delicadeza y frescura. Este hermoso arreglo destaca por una generosa selección de rosas premium bicolores en tonos crema y bordes rosa encendido, dispuestas de manera armoniosa para crear una silueta tupida y elegante. El diseño cobra una textura única gracias a una abundante base de follaje de eucalipto dólar en sutiles tonos verdes y grisáceos, delicadamente entrelazado con diminutas flores silvestres o gipsofila teñida en tonos rosados que emulan una suave neblina flotante. Presentado de forma impecable en un jarrón estilizado, es el obsequio ideal para celebrar aniversarios, expresar un amor sincero, felicitar en un cumpleaños o sorprender en cualquier ocasión con un detalle que desborda poesía natural y buen gusto.",
  "arreglo-33": "Un diseño lineal y sumamente elegante que destaca por su estructura geométrica y su romántica paleta en tonos rosa. Este exclusivo arreglo presenta una perfecta e impecable fila superior de rosas premium en un vibrante tono fucsia, las cuales coronan una densa y fresca base de follaje verde brillante salpicada con la delicada textura de crisantemos o dalias en un suave rosa pastel. Todo el conjunto se integra armónicamente en una distinguida base rectangular de madera con acabado decapado o rústico en color blanco, realzada por un vistoso listón satinado a juego en la parte frontal. Por su presentación original y ordenada, es el obsequio ideal para celebrar aniversarios, sorprender en un cumpleaños, expresar cariño sincero o decorar mesas y espacios modernos con un toque de sutil sofisticación.",
  "arreglo-34": "Una composición monocromática sumamente tierna y femenina que rinde homenaje a la delicadeza en todos sus matices. Este hermoso diseño destaca por la armoniosa combinación de rosas premium en un dulce tono rosa chicle, acompañadas por la elegante textura de gerberas y lisiantos a juego, con sutiles destellos blancos que iluminan el conjunto. Envuelto en un denso follaje verde brillante y complementado con las texturas aterciopeladas de hojas de cineraria marítima (follaje grisáceo), el arreglo se presenta de forma impecable en una original maceta cilíndrica de color rosa pastel. Es el detalle perfecto para celebrar un nacimiento, sorprender en un aniversario, festejar un cumpleaños o simplemente enviar un mensaje repleto de cariño, dulzura y frescura natural.",
  "arreglo-35": "Un diseño espectacular que roba miradas gracias a su impecable silueta esférica y una paleta de colores intensa y apasionada. Este arreglo de alta floristería destaca por la imponente presencia de girasoles radiantes, maravillosamente entrelazados con hermosas rosas premium en un profundo tono magenta o rojo cereza. El conjunto cobra una textura vibrante gracias a una tupida red de crisantemos bicolores con centros amarillos y delicados destellos de gipsofila (nube blanca). Su perfecta forma redondeada y compacta descansa con gran elegancia sobre un estilizado jarrón cilíndrico de cristal transparente, aportándole una altura y presencia inigualables. Es el obsequio ideal para celebrar un cumpleaños con energía, desear un éxito rotundo, festejar un aniversario o transformar cualquier espacio con un majestuoso estallido de color y sofisticación natural.",
  "arreglo-36": "Una propuesta majestuosa, silvestre y llena de texturas que evoca la magia de un jardín primaveral en pleno esplendor. Este diseño asimétrico destaca por su gran variedad floral, combinando hermosas rosas rosa pastel en el centro con la sofisticada presencia de lirios (liliums) por abrir, elegantes perritos (antirrinos) que aportan una estilizada verticalidad, y exóticos destellos de agapantos azules. El arreglo se enriquece con una densa y colorida base de crisantemos y margaritas en tonos borgoña, lavanda y blanco, creando un contraste visual fascinante y lleno de relieve. Presentado de forma impecable en un distinguido cofre rectangular de madera con acabado rústico o decapado, es el detalle ideal para sorprender en un aniversario, celebrar un cumpleaños de forma espectacular o engalanar un espacio con un toque de alta floristería y distinción natural.",
  "arreglo-37": "Una declaración atemporal de amor y sofisticación que nunca pasa de moda. Este espectacular arreglo destaca por una generosa selección de rosas premium en un vibrante e intenso tono rojo carmesí, dispuestas de forma armónica para crear una silueta tupida, imponente y sofisticada. El diseño se complementa de manera perfecta con una delicada cama de gipsofila (nube blanca) que simula un manto estelar, sutiles destellos aterciopelados de hojas de cineraria marítima en la base floral, y un denso follaje verde brillante. Presentado con gran distinción en un jarrón de vidrio estilizado y coronado por un fino listón satinado de color rojo a juego, es el obsequio idóneo para celebrar aniversarios románticos, el Día de San Valentín, o simplemente sorprender a esa persona especial con un gesto que desborda elegancia y un sentimiento profundo.",
  "arreglo-38": "Una propuesta sumamente coqueta, fresca y de estilo rústico-chic que cautiva por su original presentación. Este hermoso arreglo destaca por su diseño asimétrico y campestre, coronado en el centro por radiantes rosas premium en tono rosa vibrante, acompañadas por la estilizada altura de flores perrito (antirrinos) en tonos pastel y una generosa y tupida base de crisantemos y margaritas en una gama de blancos puros, rosas suaves y profundos matices magenta. Todo el conjunto se integra a la perfección en una encantadora jarra artesanal de cerámica teñida en un dulce color rosa pastel. Por su diseño alegre, fresco y lleno de texturas, es el obsequio ideal para sorprender en un cumpleaños, celebrar el Día de las Madres, enviar los mejores deseos de pronta recuperación o simplemente iluminar con sutil delicadeza cualquier rincón especial del hogar.",
  "arreglo-39": "Un diseño tierno, etéreo y rebosante de encanto que recrea la delicadeza de un jardín de fantasía. Este hermoso arreglo destaca por su variedad de texturas y alturas, combinando la estilizada elegancia de flores perrito (antirrinos) en tono lila con la suavidad de gerberas y claveles en tonos rosa pastel, complementados con destellos amarillos que aportan una nota sutil de luz. El conjunto adquiere una textura sumamente elegante y moderna gracias a la incorporación de follaje aterciopelado de cineraria marítima (hojas grisáceas) y ramas de eucalipto. Presentado con una impecable envoltura decorativa estilo ramo coreano en sutiles capas de tonos rosa y lavanda, ceñido con un delicado listón satinado y colocado en un florero estilizado, es el detalle ideal para celebrar un cumpleaños dulce, enviar una felicitación llena de ternura o sorprender a alguien especial con un gesto repleto de poesía natural.",
  "arreglo-40": "Una propuesta sofisticada, imponente y repleta de matices exóticos que rinde homenaje a la majestuosidad de los tonos púrpuras. Este diseño de alta floristería destaca por su rica diversidad de texturas y alturas, combinando la elegante verticalidad de los perritos (antirrinos) en tono magenta intenso con la delicadeza de rosas y lisiantos en un romántico lila pastel. Pompones de crisantemos vibrantes, hortensias en tonos lavanda y sutiles encajes de flores silvestres verdes añaden volumen y una frescura silvestre única. El conjunto se presenta envuelto de forma impecable en un papel decorativo premium estilo coreano de tonalidades ciruela y violeta profundo, abrazado por un fino listón satinado de color lila y colocado con distinción en un jarrón de vidrio estilizado. Es el obsequio ideal para sorprender en un aniversario, celebrar un cumpleaños con elegancia o engalanar un espacio especial con un detalle repleto de carácter, misterio y sutil sofisticación.",
  "arreglo-41": "Un diseño monumental, sofisticado y de una elegancia sublime que rinde homenaje a la belleza atemporal del blanco puro. Este arreglo de alta floristería destaca por su imponente estructura vertical, coronada por estilizados lirios (liliums) en vástagos altos listos para abrir, acompañados por la distinguida presencia de flores perrito (antirrinos) y delicados capullos que aportan una textura estilizada y majestuosa. En la base, el conjunto se complementa con radiantes gerberas y lisiantos completamente abiertos, entrelazados de forma impecable con el toque ornamental y vanguardista de una col de jardín (brassica) y una abundante selección de follaje verde y ramas de eucalipto dólar en tonos grisáceos. Presentado con gran distinción en un jarrón oscuro que resalta la luminosidad de las flores, es el obsequio ideal para ocasiones solemnes, aniversarios elegantes, condolencias con absoluto respeto o para engalanar espacios residenciales y corporativos con un aire de paz, frescura y sutil sofisticación.",
  "arreglo-42": "",
  "arreglo-43": "",
  "arreglo-44": "",
  "arreglo-45": "",
